...
### Phase 1: Chatbot MVP
**Goal**: A working personal chatbot end-to-end — ask about a ticker in the browser and get a
cited, streamed, memory-grounded answer that continues across turns.
...
Plans:
- [ ] 01-01: Repo bootstrap + schema-contract doc + live-index smoke (slice 0)
- [ ] 01-02: Backend skeleton + Pinecone client + health/ready (slice 1)
- [ ] 01-03: Anthropic client + non-streaming RAG chat endpoint (slice 2)
