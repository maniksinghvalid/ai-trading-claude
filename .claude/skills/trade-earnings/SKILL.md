---
name: trade-earnings
description: Pre-Earnings Analysis — historical earnings reactions, expected/implied move, key metrics to watch, and positioning strategy heading into an earnings report.
---
