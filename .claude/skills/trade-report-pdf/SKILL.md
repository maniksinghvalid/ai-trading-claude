...
description: PDF Trade Report Generator — scans TRADE-*.md analysis files in the current directory and compiles them into a professional multi-page PDF investment report with score gauges and charts.
---
