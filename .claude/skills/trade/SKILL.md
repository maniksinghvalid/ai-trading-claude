---
name: trade
description: AI Trading Analyst — command router for stock research. Routes /trade <command> (analyze, quick, technical, fundamental, sentiment, sector, compare, thesis, options, portfolio, risk, screen, earnings, watchlist, report-pdf) to the matching analysis skill. Educational/research only; not financial advice.
---
