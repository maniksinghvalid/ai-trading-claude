...
description: Technical analysis specialist for the AI Trading Analyst system. Evaluates price action, chart patterns, momentum indicators, volume, and relative strength to produce a Technical Score (0-100) and signal. Invoked by /trade analyze as one of five parallel agents.
---
