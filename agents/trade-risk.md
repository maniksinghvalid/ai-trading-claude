---
name: trade-risk
description: Risk assessment specialist for the AI Trading Analyst system. Analyzes volatility, downside scenarios, correlation, liquidity, and position sizing to produce an inverted Risk Score (0-100, higher = lower risk). Invoked by /trade analyze as one of five parallel agents.
---
